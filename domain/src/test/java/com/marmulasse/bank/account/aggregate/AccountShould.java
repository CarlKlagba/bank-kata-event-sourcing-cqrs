...
public class AccountShould {
    ...
    public void add_creation_event_when_creating_account() throws Exception {
        Account account = Account.empty();
        assertThat(account.getUncommittedChanged()).containsOnly(new NewAccountCreated(account.getProjection().getAccountId(), Balance.ZERO));
    }
    ...
    public void add_deposit_event_to_uncommitted_change_when_deposit_made() throws Exception {
        ...
        assertThat(account.getUncommittedChanged()).contains(new NewDepositMade(account.getProjection().getAccountId(), Amount.of(10.0)));
    }
    ...
    public void add_withdraw_event_to_uncommitted_change_when_withdraw_made() throws Exception {
        ...
        assertThat(account.getUncommittedChanged()).contains(new NewWithdrawMade(account.getProjection().getAccountId(), Amount.of(10.0)));
    }
